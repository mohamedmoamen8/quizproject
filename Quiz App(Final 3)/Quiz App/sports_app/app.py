...
sports_app = Blueprint('sports_app', __name__, template_folder='templates', static_folder='static')

# Load questions from the JSON file
def load_questions():
    try:
        # Define the path to the sports_questions.json file in the 'json' folder
        json_file_path = os.path.join(os.path.dirname(__file__), '..', 'json', 'sports_questions.json')
...
@sports_app.route('/api/questions')
def questions():
