...
movies_app = Blueprint('movies_app', __name__, template_folder='templates', static_folder='static')
...
def load_questions():
    try:
        ...
        json_file_path = os.path.join(os.path.dirname(__file__), '..', 'json', 'movies_questions.json')
...
@movies_app.route('/api/questions')
def questions():
